...
function calcularQuadrado(numb) {
    return (numb * numb);
}
;
...
function conversaoFahrenheit(n1) {
    return ((n1 * 1.8) + 32);
}
;
...
function formtMaiusc(str) {
    return str.charAt(0).toUpperCase() + str.slice(1).toLowerCase();
}
console.log("Formatar a string 'joão' para maiúscula:", formtMaiusc("joão"));
